...
public class PresentersModule {
    ...
    @Singleton
    @Provides
    StatusFragmentPresenter provideStatusFragmentPresenter(Context context) {
        return new StatusFragmentPresenter(context);
    }
    ...
    @Singleton
    @Provides
    MVPActivityPresenter provideMainActivityPresenter(Context context) {
